    ...
    <form className="space-y-6" onSubmit={handleSubmit}>
      <div className="bg-muted/20 p-4 rounded-lg border border-emerald-900/20 space-y-3">
        <div className="flex items-center">
          <CalendarRange className="h-5 w-5 text-emerald-400 mr-2" />
          <span className="text-white font-medium">
            {format(new Date(slot.startTime), "EEEE, MMMM d, yyyy")}
          </span>
        </div>
        <div className="flex items-center">
          <Clock11Icon className="h-5 w-5 text-emerald-400 mr-2" />
      ...
      <div className="space-y-3">
        ...
        <Textarea
          ...
          value={description}
          placeholder="Please provide any details about your medical concern or what you'd like to discus in the appointment..."
