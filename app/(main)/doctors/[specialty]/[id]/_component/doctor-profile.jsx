        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-2">
                <Clock2 className="h-5 w-5 text-emerald-400" />
                <h3 className="text-white font-medium">Availabilty</h3>
              </div>
            </div>

            {totalSlots > 0 ? (
              <div className="flex items-center">
                <CalendarCheck className="h-5 w-5 text-emerald-400 mr-2" />
          ...
          <div id="booking-section">
            <Card className="border-emerald-900/20">
              <CardHeader>
                ...
                <CardDescription>
                  Select a time slot provide details for your consultation
                </CardDescription>
              </CardHeader>
              <CardContent>
                {totalSlots > 0 ? (
                  ...
                  <div className="text-center py-6">
                    <CalendarRange className="h-2 w-12 mx-auto text-muted-foreground mb-3" />
                    <h3 className="text-xl font-medium text-white mb-2">
                      No available slots
                    </h3>
                    <p className="text-muted-foreground">
                      This doctor does&apos;t have any available appointment
